	...
	for i in range(bin_names.size): #should usually be 6
		...
		if(slicing==True):
			if(process=="dijet"):
				...
				ax_ratio_bin.set_xlim(50.0, _ybysbin_xlim_up_zjet[bname])
			fig_ratio_bin.savefig("%s_rel_stat_uncs_%s_sliced.png"%(process,bname))

		else:
			fig_ratio_bin.savefig("%s_rel_stat_uncs_%s.png"%(process,bname))
		...
		if(slicing==True):
			...
			fig_ratio_bin.savefig("%s_rel_stat_uncs_%s_zoomedTo20_sliced.png"%(process,bname))
		else:
			fig_ratio_bin.savefig("%s_rel_stat_uncs_%s_zoomedTo20.png"%(process,bname))
