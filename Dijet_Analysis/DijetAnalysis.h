...
// Wed Jun 12 11:20:23 2019 by ROOT version 6.14/06
// from TTree Events/Events
// found on file: ../../../data/Run2018D_JetHT_NANOAOD_Nano14Dec2018_ver2-v1_E56CDBE1.root
//////////////////////////////////////////////////////////
...
#include "FriendClass.h" 	//include FriendClass for MC uncs
...
const char* runperiod="X";			//for MC... not used, just to give it some nonsense variable it cannot process
...
const char* generator="HTpythia";		//if looking at HT pythia8 sample


//std::string runperiod="A";	
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nJet;
   Float_t         Jet_area[44];   //[nJet]
   Float_t         Jet_btagCMVA[44];   //[nJet]
   Float_t         Jet_btagCSVV2[44];   //[nJet]
   Float_t         Jet_btagDeepB[44];   //[nJet]
   Float_t         Jet_btagDeepC[44];   //[nJet]
   Float_t         Jet_btagDeepFlavB[44];   //[nJet]
   Float_t         Jet_chEmEF[44];   //[nJet]
   Float_t         Jet_chHEF[44];   //[nJet]
   Float_t         Jet_eta[44];   //[nJet]
   Float_t         Jet_mass[44];   //[nJet]
   Float_t         Jet_muEF[44];   //[nJet]
   Float_t         Jet_neEmEF[44];   //[nJet]
   Float_t         Jet_neHEF[44];   //[nJet]
   Float_t         Jet_phi[44];   //[nJet]
   Float_t         Jet_pt[44];   //[nJet]
   Float_t         Jet_qgl[44];   //[nJet]
   Float_t         Jet_rawFactor[44];   //[nJet]
   Float_t         Jet_bRegCorr[44];   //[nJet]
   Float_t         Jet_bRegRes[44];   //[nJet]
   Int_t           Jet_electronIdx1[44];   //[nJet]
   Int_t           Jet_electronIdx2[44];   //[nJet]
   Int_t           Jet_jetId[44];   //[nJet]
   Int_t           Jet_muonIdx1[44];   //[nJet]
   Int_t           Jet_muonIdx2[44];   //[nJet]
   Int_t           Jet_nConstituents[44];   //[nJet]
   Int_t           Jet_nElectrons[44];   //[nJet]
   Int_t           Jet_nMuons[44];   //[nJet]
   Int_t           Jet_puId[44];   //[nJet]
   Float_t         LHE_HT;	//--> copied from HT files
   Float_t         LHE_HTIncoming; //-->copied from HT files
   ...
   Float_t         Photon_mvaIDV1[14];   //[nPhoton]
   ...
   Int_t           Photon_cutBasedBitmap[14];   //[nPhoton]
   Int_t           Photon_cutBasedV1Bitmap[14];   //[nPhoton]
   ...
   */
   ...
   UInt_t          nGenJet;
   Float_t         GenJet_eta[44];   	//[nGenJet]
   Float_t         GenJet_mass[44];   	//[nGenJet]
   Float_t         GenJet_phi[44];   	//[nGenJet]
   Float_t         GenJet_pt[44];   	//[nGenJet]
   ...
   Float_t         Jet_pt_raw[44];   //[nJet]
   Float_t         Jet_pt_nom[44];   //[nJet]
   Float_t         Jet_mass_raw[44];   //[nJet]
   Float_t         Jet_mass_nom[44];   //[nJet]
   Float_t         Jet_corr_JEC[44];   //[nJet]
   Float_t         Jet_corr_JER[44];   //[nJet]
   Float_t         Jet_pt_jerUp[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteStatUp[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteScaleUp[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteSampleUp[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteFlavMapUp[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteMPFBiasUp[44];   //[nJet]
   Float_t         Jet_pt_jesFragmentationUp[44];   //[nJet]
   Float_t         Jet_pt_jesSinglePionECALUp[44];   //[nJet]
   Float_t         Jet_pt_jesSinglePionHCALUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorQCDUp[44];   //[nJet]
   Float_t         Jet_pt_jesTimePtEtaUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeJEREC1Up[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeJEREC2Up[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeJERHFUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtBBUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtEC1Up[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtEC2Up[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtHFUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeBalUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeSampleUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeFSRUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeStatFSRUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeStatECUp[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeStatHFUp[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpDataMCUp[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtRefUp[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtBBUp[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtEC1Up[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtEC2Up[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtHFUp[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpMuZeroUp[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpEnvelopeUp[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalPileUpUp[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalRelativeUp[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalPtUp[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalScaleUp[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalAbsoluteUp[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalMCUp[44];   //[nJet]
   Float_t         Jet_pt_jesTotalUp[44];   //[nJet]
   Float_t         Jet_pt_jesTotalNoFlavorUp[44];   //[nJet]
   Float_t         Jet_pt_jesTotalNoTimeUp[44];   //[nJet]
   Float_t         Jet_pt_jesTotalNoFlavorNoTimeUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorZJetUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPhotonJetUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureGluonUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureQuarkUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureCharmUp[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureBottomUp[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunAUp[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunBUp[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunCUp[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunDUp[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupMPFInSituUp[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupIntercalibrationUp[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupbJESUp[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupFlavorUp[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupUncorrelatedUp[44];   //[nJet]
   Float_t         Jet_pt_jerDown[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteStatDown[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteScaleDown[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteSampleDown[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteFlavMapDown[44];   //[nJet]
   Float_t         Jet_pt_jesAbsoluteMPFBiasDown[44];   //[nJet]
   Float_t         Jet_pt_jesFragmentationDown[44];   //[nJet]
   Float_t         Jet_pt_jesSinglePionECALDown[44];   //[nJet]
   Float_t         Jet_pt_jesSinglePionHCALDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorQCDDown[44];   //[nJet]
   Float_t         Jet_pt_jesTimePtEtaDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeJEREC1Down[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeJEREC2Down[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeJERHFDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtBBDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtEC1Down[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtEC2Down[44];   //[nJet]
   Float_t         Jet_pt_jesRelativePtHFDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeBalDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeSampleDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeFSRDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeStatFSRDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeStatECDown[44];   //[nJet]
   Float_t         Jet_pt_jesRelativeStatHFDown[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpDataMCDown[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtRefDown[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtBBDown[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtEC1Down[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtEC2Down[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpPtHFDown[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpMuZeroDown[44];   //[nJet]
   Float_t         Jet_pt_jesPileUpEnvelopeDown[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalPileUpDown[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalRelativeDown[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalPtDown[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalScaleDown[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalAbsoluteDown[44];   //[nJet]
   Float_t         Jet_pt_jesSubTotalMCDown[44];   //[nJet]
   Float_t         Jet_pt_jesTotalDown[44];   //[nJet]
   Float_t         Jet_pt_jesTotalNoFlavorDown[44];   //[nJet]
   Float_t         Jet_pt_jesTotalNoTimeDown[44];   //[nJet]
   Float_t         Jet_pt_jesTotalNoFlavorNoTimeDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorZJetDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPhotonJetDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureGluonDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureQuarkDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureCharmDown[44];   //[nJet]
   Float_t         Jet_pt_jesFlavorPureBottomDown[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunADown[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunBDown[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunCDown[44];   //[nJet]
   Float_t         Jet_pt_jesTimeRunDDown[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupMPFInSituDown[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupIntercalibrationDown[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupbJESDown[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupFlavorDown[44];   //[nJet]
   Float_t         Jet_pt_jesCorrelationGroupUncorrelatedDown[44];   //[nJet]


   // Custom 2D array for uncertainties
   static const int nSource = 56;
   Float_t Jet_pt_uncUp[nSource][44]; // [nJet]
   Float_t Jet_pt_uncDw[nSource][44]; // [nJet]
   ...
   TBranch        *b_Jet_puId;   //!	
   TBranch        *b_LHE_HT;   //! --> copied from HT samples
   TBranch        *b_LHE_HTIncoming;   //! --> copied from HT samples
   ...
   */
   ...
   //virtual void 	dijet_get_lumi();//added(renamed get_lumi_text()).
   virtual void		triggerpaths();	//ADDED!!!!!!
   virtual void		unfold();		//ADDED!	(for unfolding purposes)
   ...
   virtual void     FastLoop();			//added for fast trigger-handling
};

#endif

#ifdef DijetAnalysis_cxx
/*
DijetAnalysis::DijetAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../data/Run2018D_JetHT_NANOAOD_Nano14Dec2018_ver2-v1_E56CDBE1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../data/Run2018D_JetHT_NANOAOD_Nano14Dec2018_ver2-v1_E56CDBE1.root");
      }
   ...
   if (tree == 0) {
      if(montecarlo==false){ //if data
		  ...
		  if(strcmp(runperiod,"A")==0){
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018A_haddskim.root");
			  if (!f || !f->IsOpen()) {
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018A_haddskim.root");
			  }
			  f->GetObject("Events",tree);
		  }//end if runperiod A

		  else if(strcmp(runperiod,"B")==0){
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018B_haddskim.root");
			  if (!f || !f->IsOpen()) {
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018B_haddskim.root");
			  }
			  f->GetObject("Events",tree);
		  }//end if runperiod B

		  else if(strcmp(runperiod,"C")==0){
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018C_haddskim.root");
			  if (!f || !f->IsOpen()) {
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018C_haddskim.root");
			  }
			  f->GetObject("Events",tree);
		  }//end if runperiod C

		  else if(strcmp(runperiod,"D")==0){
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018D_haddskim.root");
			  if (!f || !f->IsOpen()) {
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/data_skimmed_hadd/dijet/JetHT_Run2018D_haddskim.root");
			  }
			  f->GetObject("Events",tree);
		  }//end if runperiod D
		  ...
		  //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("0BD9CF76-F784-5C4C-896E-4A7D97B04661.root"); //for now: use this small MC file (~1.9 GB)
		  //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/RunIIAutumn18NanoAODv5/DijetMC/old_hadd/QCD_Pt-15to7000_Flat_mc.root"); //Big file, containing 18 small ones (~23.0 GB)

		  if(strcmp(generator,"herwig")==0){//if herwig7 requested
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/mc_skimmed_hadd/dijet/QCD_Pt-15to7000_mc_herwig7_haddskim.root"); //hadd of all the MC files (unskimmed, ~21.0 GB)
			  if (!f || !f->IsOpen()) {
				 //f = new TFile("/Volumes/CMSdata/RunIIAutumn18NanoAODv5/DijetMC/old_hadd/QCD_Pt-15to7000_Flat_mc.root");	//TO BE CHANGED!!
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/mc_skimmed_hadd/dijet/QCD_Pt-15to7000_mc_herwig7_haddskim.root");	//unskimmed.
			  }
			  f->GetObject("Events",tree);
		  }//end if herwig
		  else if(strcmp(generator, "pythia")==0){//if pythia8 requested
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/mc_skimmed_hadd/dijet/QCD_Pt-15to7000_mc_pythia8_haddskim.root"); //hadd of all the MC files (unskimmed, ~21.0 GB)
			  if (!f || !f->IsOpen()) {
				 //f = new TFile("/Volumes/CMSdata/RunIIAutumn18NanoAODv5/DijetMC/old_hadd/QCD_Pt-15to7000_Flat_mc.root");	//TO BE CHANGED!!
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/mc_skimmed_hadd/dijet/QCD_Pt-15to7000_mc_pythia8_haddskim.root");	//unskimmed.
			  }
			  f->GetObject("Events",tree);
		  }//end if pythia
		  else if(strcmp(generator, "HTpythia")==0){//if HT sample of pythia8 requested
			  TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/mc_skimmed_hadd/dijet/QCD_HT_madgraph_pythia8_hadd_small.root"); //hadd of all the MC files (unskimmed,GB)
			  if (!f || !f->IsOpen()) {
				 //f = new TFile("/Volumes/CMSdata/RunIIAutumn18NanoAODv5/DijetMC/old_hadd/QCD_Pt-15to7000_Flat_mc.root");	//TO BE CHANGED!!
				 f = new TFile("/Volumes/CMSdata/used_for_analysis/mc_skimmed_hadd/dijet/QCD_HT_madgraph_pythia8_hadd_small.root");	//unskimmed.
			  }
			  f->GetObject("Events",tree);
		  }//end if HT sample pythia
	  }//end if mc
   }
   Init(tree);
}
...
Int_t DijetAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DijetAnalysis::LoadTree(Long64_t entry)
{
// Set the environment to read one entry
   if (!fChain) return -5;
   Long64_t centry = fChain->LoadTree(entry);
   //fFriends->LoadTree(entry);
...
void DijetAnalysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("LHE_HT", &LHE_HT, &b_LHE_HT); //-->copied from HT samples
   fChain->SetBranchAddress("LHE_HTIncoming", &LHE_HTIncoming, &b_LHE_HTIncoming); //-->copied from HT samples
   ...
   if(montecarlo){
		...
		if(strcmp(generator,"herwig")==0){//if herwig7 requested
			//fChain->AddFriend("Friends", "~/Documents/JetAnalysis/master_thesis_git/master_thesis/Tools/Uncertainties/mc_QCD_Pt-15to7000_Flat_0BD9CF76-F784-5C4C-896E-4A7D97B04661_all_jmeMCtest_singlefile100000_Friend.root");
			//TFile *friendfile = (TFile*)gROOT->GetListOfFiles()->FindObject("/Users/bschilli/Documents/JetAnalysis/master_thesis_git/master_thesis/Tools/Uncertainties/mc_QCD_Pt-15to7000_Flat_0BD9CF76-F784-5C4C-896E-4A7D97B04661_all_jmeMCtest_singlefile100000_Friend.root"); //hadd of all the MC files (unskimmed, ~21.0 GB)
			TFile *friendfile = (TFile*)gROOT->GetListOfFiles()->FindObject("/Volumes/CMSdata/used_for_analysis/uncs_mc_jme_hadd/dijet/QCD_Pt-15to7000_mc_herwig7_All_jmeUncSources_haddslim.root"); //hadd of all the MC unc files (unskimmed, but slimmed, ~53.0 GB)
			if (!friendfile || !friendfile->IsOpen()) {
				//f = new TFile("/Volumes/CMSdata/RunIIAutumn18NanoAODv5/DijetMC/old_hadd/QCD_Pt-15to7000_Flat_mc.root");	//TO BE CHANGED!!
				friendfile = new TFile("/Volumes/CMSdata/used_for_analysis/uncs_mc_jme_hadd/dijet/QCD_Pt-15to7000_mc_herwig7_All_jmeUncSources_haddslim.root");	//unskimmed.
			}
			friendfile->GetObject("Friends", fFriends);
			TTree *friendtree;
			//friendfile->GetObject("Friends", friendtree);

			//FriendClass(fFriends);	//creates FriendClass object
			//need to do all the fFriends->SetBranchAddress() etc.
			//FriendClass::Init(fFriends);	//???
			//fChain->AddFriend("Friends", friendfile);

			//InitFriendBranches(friendtree);
			InitFriendBranches(fFriends);
			fFriends->GetBranch("Jet_pt_nom")->Print();
...
void DijetAnalysis::InitFriendBranches(TTree *friendtree){
   ...
   //fFriends->SetBranchAddress("Jet_pt_jesAbsoluteStatUp", Jet_pt_jesAbsoluteStatUp, &b_Jet_pt_jesAbsoluteStatUp);
   fFriends->SetBranchAddress("Jet_pt_jesAbsoluteStatUp", Jet_pt_uncUp[0], &b_Jet_pt_jesAbsoluteStatUp);
   //fFriends->SetBranchAddress("Jet_pt_jesAbsoluteScaleUp", Jet_pt_jesAbsoluteScaleUp, &b_Jet_pt_jesAbsoluteScaleUp);
   fFriends->SetBranchAddress("Jet_pt_jesAbsoluteScaleUp", Jet_pt_uncUp[1], &b_Jet_pt_jesAbsoluteScaleUp);
   //fFriends->SetBranchAddress("Jet_pt_jesAbsoluteSampleUp", Jet_pt_jesAbsoluteSampleUp, &b_Jet_pt_jesAbsoluteSampleUp);
   fFriends->SetBranchAddress("Jet_pt_jesAbsoluteSampleUp", Jet_pt_uncUp[2], &b_Jet_pt_jesAbsoluteSampleUp);
   //fFriends->SetBranchAddress("Jet_pt_jesAbsoluteFlavMapUp", Jet_pt_jesAbsoluteFlavMapUp, &b_Jet_pt_jesAbsoluteFlavMapUp);
   fFriends->SetBranchAddress("Jet_pt_jesAbsoluteFlavMapUp", Jet_pt_uncUp[3], &b_Jet_pt_jesAbsoluteFlavMapUp);
   //fFriends->SetBranchAddress("Jet_pt_jesAbsoluteMPFBiasUp", Jet_pt_jesAbsoluteMPFBiasUp, &b_Jet_pt_jesAbsoluteMPFBiasUp);
   fFriends->SetBranchAddress("Jet_pt_jesAbsoluteMPFBiasUp", Jet_pt_uncUp[4], &b_Jet_pt_jesAbsoluteMPFBiasUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFragmentationUp", Jet_pt_jesFragmentationUp, &b_Jet_pt_jesFragmentationUp);
   fFriends->SetBranchAddress("Jet_pt_jesFragmentationUp", Jet_pt_uncUp[5], &b_Jet_pt_jesFragmentationUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSinglePionECALUp", Jet_pt_jesSinglePionECALUp, &b_Jet_pt_jesSinglePionECALUp);
   fFriends->SetBranchAddress("Jet_pt_jesSinglePionECALUp", Jet_pt_uncUp[6], &b_Jet_pt_jesSinglePionECALUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSinglePionHCALUp", Jet_pt_jesSinglePionHCALUp, &b_Jet_pt_jesSinglePionHCALUp);
   fFriends->SetBranchAddress("Jet_pt_jesSinglePionHCALUp", Jet_pt_uncUp[7], &b_Jet_pt_jesSinglePionHCALUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorQCDUp", Jet_pt_jesFlavorQCDUp, &b_Jet_pt_jesFlavorQCDUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorQCDUp", Jet_pt_uncUp[8], &b_Jet_pt_jesFlavorQCDUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTimePtEtaUp", Jet_pt_jesTimePtEtaUp, &b_Jet_pt_jesTimePtEtaUp);
   fFriends->SetBranchAddress("Jet_pt_jesTimePtEtaUp", Jet_pt_uncUp[9], &b_Jet_pt_jesTimePtEtaUp);

   //fFriends->SetBranchAddress("Jet_pt_jesRelativeJEREC1Up", Jet_pt_jesRelativeJEREC1Up, &b_Jet_pt_jesRelativeJEREC1Up);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeJEREC1Up", Jet_pt_uncUp[10], &b_Jet_pt_jesRelativeJEREC1Up);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeJEREC2Up", Jet_pt_jesRelativeJEREC2Up, &b_Jet_pt_jesRelativeJEREC2Up);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeJEREC2Up", Jet_pt_uncUp[11], &b_Jet_pt_jesRelativeJEREC2Up);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeJERHFUp", Jet_pt_jesRelativeJERHFUp, &b_Jet_pt_jesRelativeJERHFUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeJERHFUp", Jet_pt_uncUp[12], &b_Jet_pt_jesRelativeJERHFUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativePtBBUp", Jet_pt_jesRelativePtBBUp, &b_Jet_pt_jesRelativePtBBUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativePtBBUp", Jet_pt_uncUp[13], &b_Jet_pt_jesRelativePtBBUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativePtEC1Up", Jet_pt_jesRelativePtEC1Up, &b_Jet_pt_jesRelativePtEC1Up);
   fFriends->SetBranchAddress("Jet_pt_jesRelativePtEC1Up", Jet_pt_uncUp[14], &b_Jet_pt_jesRelativePtEC1Up);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativePtEC2Up", Jet_pt_jesRelativePtEC2Up, &b_Jet_pt_jesRelativePtEC2Up);
   fFriends->SetBranchAddress("Jet_pt_jesRelativePtEC2Up", Jet_pt_uncUp[15], &b_Jet_pt_jesRelativePtEC2Up);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativePtHFUp", Jet_pt_jesRelativePtHFUp, &b_Jet_pt_jesRelativePtHFUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativePtHFUp", Jet_pt_uncUp[16], &b_Jet_pt_jesRelativePtHFUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeBalUp", Jet_pt_jesRelativeBalUp, &b_Jet_pt_jesRelativeBalUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeBalUp", Jet_pt_uncUp[17], &b_Jet_pt_jesRelativeBalUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeSampleUp", Jet_pt_jesRelativeSampleUp, &b_Jet_pt_jesRelativeSampleUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeSampleUp", Jet_pt_uncUp[18], &b_Jet_pt_jesRelativeSampleUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeFSRUp", Jet_pt_jesRelativeFSRUp, &b_Jet_pt_jesRelativeFSRUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeFSRUp", Jet_pt_uncUp[19], &b_Jet_pt_jesRelativeFSRUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeStatFSRUp", Jet_pt_jesRelativeStatFSRUp, &b_Jet_pt_jesRelativeStatFSRUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeStatFSRUp", Jet_pt_uncUp[20], &b_Jet_pt_jesRelativeStatFSRUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeStatECUp", Jet_pt_jesRelativeStatECUp, &b_Jet_pt_jesRelativeStatECUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeStatECUp", Jet_pt_uncUp[21], &b_Jet_pt_jesRelativeStatECUp);
   //fFriends->SetBranchAddress("Jet_pt_jesRelativeStatHFUp", Jet_pt_jesRelativeStatHFUp, &b_Jet_pt_jesRelativeStatHFUp);
   fFriends->SetBranchAddress("Jet_pt_jesRelativeStatHFUp", Jet_pt_uncUp[22], &b_Jet_pt_jesRelativeStatHFUp);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpDataMCUp", Jet_pt_jesPileUpDataMCUp, &b_Jet_pt_jesPileUpDataMCUp);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpDataMCUp", Jet_pt_uncUp[23], &b_Jet_pt_jesPileUpDataMCUp);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpPtRefUp", Jet_pt_jesPileUpPtRefUp, &b_Jet_pt_jesPileUpPtRefUp);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpPtRefUp", Jet_pt_uncUp[24], &b_Jet_pt_jesPileUpPtRefUp);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpPtBBUp", Jet_pt_jesPileUpPtBBUp, &b_Jet_pt_jesPileUpPtBBUp);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpPtBBUp", Jet_pt_uncUp[25], &b_Jet_pt_jesPileUpPtBBUp);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpPtEC1Up", Jet_pt_jesPileUpPtEC1Up, &b_Jet_pt_jesPileUpPtEC1Up);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpPtEC1Up", Jet_pt_uncUp[26], &b_Jet_pt_jesPileUpPtEC1Up);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpPtEC2Up", Jet_pt_jesPileUpPtEC2Up, &b_Jet_pt_jesPileUpPtEC2Up);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpPtEC2Up", Jet_pt_uncUp[27], &b_Jet_pt_jesPileUpPtEC2Up);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpPtHFUp", Jet_pt_jesPileUpPtHFUp, &b_Jet_pt_jesPileUpPtHFUp);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpPtHFUp", Jet_pt_uncUp[28], &b_Jet_pt_jesPileUpPtHFUp);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpMuZeroUp", Jet_pt_jesPileUpMuZeroUp, &b_Jet_pt_jesPileUpMuZeroUp);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpMuZeroUp", Jet_pt_uncUp[29], &b_Jet_pt_jesPileUpMuZeroUp);
   //fFriends->SetBranchAddress("Jet_pt_jesPileUpEnvelopeUp", Jet_pt_jesPileUpEnvelopeUp, &b_Jet_pt_jesPileUpEnvelopeUp);
   fFriends->SetBranchAddress("Jet_pt_jesPileUpEnvelopeUp", Jet_pt_uncUp[30], &b_Jet_pt_jesPileUpEnvelopeUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSubTotalPileUpUp", Jet_pt_jesSubTotalPileUpUp, &b_Jet_pt_jesSubTotalPileUpUp);
   fFriends->SetBranchAddress("Jet_pt_jesSubTotalPileUpUp", Jet_pt_uncUp[31], &b_Jet_pt_jesSubTotalPileUpUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSubTotalRelativeUp", Jet_pt_jesSubTotalRelativeUp, &b_Jet_pt_jesSubTotalRelativeUp);
   fFriends->SetBranchAddress("Jet_pt_jesSubTotalRelativeUp", Jet_pt_uncUp[32], &b_Jet_pt_jesSubTotalRelativeUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSubTotalPtUp", Jet_pt_jesSubTotalPtUp, &b_Jet_pt_jesSubTotalPtUp);
   fFriends->SetBranchAddress("Jet_pt_jesSubTotalPtUp", Jet_pt_uncUp[33], &b_Jet_pt_jesSubTotalPtUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSubTotalScaleUp", Jet_pt_jesSubTotalScaleUp, &b_Jet_pt_jesSubTotalScaleUp);
   fFriends->SetBranchAddress("Jet_pt_jesSubTotalScaleUp", Jet_pt_uncUp[34], &b_Jet_pt_jesSubTotalScaleUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSubTotalAbsoluteUp", Jet_pt_jesSubTotalAbsoluteUp, &b_Jet_pt_jesSubTotalAbsoluteUp);
   fFriends->SetBranchAddress("Jet_pt_jesSubTotalAbsoluteUp", Jet_pt_uncUp[35], &b_Jet_pt_jesSubTotalAbsoluteUp);
   //fFriends->SetBranchAddress("Jet_pt_jesSubTotalMCUp", Jet_pt_jesSubTotalMCUp, &b_Jet_pt_jesSubTotalMCUp);
   fFriends->SetBranchAddress("Jet_pt_jesSubTotalMCUp", Jet_pt_uncUp[36], &b_Jet_pt_jesSubTotalMCUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTotalUp", Jet_pt_jesTotalUp, &b_Jet_pt_jesTotalUp);
   fFriends->SetBranchAddress("Jet_pt_jesTotalUp", Jet_pt_uncUp[37], &b_Jet_pt_jesTotalUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTotalNoFlavorUp", Jet_pt_jesTotalNoFlavorUp, &b_Jet_pt_jesTotalNoFlavorUp);
   fFriends->SetBranchAddress("Jet_pt_jesTotalNoFlavorUp", Jet_pt_uncUp[38], &b_Jet_pt_jesTotalNoFlavorUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTotalNoTimeUp", Jet_pt_jesTotalNoTimeUp, &b_Jet_pt_jesTotalNoTimeUp);
   fFriends->SetBranchAddress("Jet_pt_jesTotalNoTimeUp", Jet_pt_uncUp[39], &b_Jet_pt_jesTotalNoTimeUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTotalNoFlavorNoTimeUp", Jet_pt_jesTotalNoFlavorNoTimeUp, &b_Jet_pt_jesTotalNoFlavorNoTimeUp);
   fFriends->SetBranchAddress("Jet_pt_jesTotalNoFlavorNoTimeUp", Jet_pt_uncUp[40], &b_Jet_pt_jesTotalNoFlavorNoTimeUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorZJetUp", Jet_pt_jesFlavorZJetUp, &b_Jet_pt_jesFlavorZJetUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorZJetUp", Jet_pt_uncUp[41], &b_Jet_pt_jesFlavorZJetUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorPhotonJetUp", Jet_pt_jesFlavorPhotonJetUp, &b_Jet_pt_jesFlavorPhotonJetUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorPhotonJetUp", Jet_pt_uncUp[42], &b_Jet_pt_jesFlavorPhotonJetUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorPureGluonUp", Jet_pt_jesFlavorPureGluonUp, &b_Jet_pt_jesFlavorPureGluonUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorPureGluonUp", Jet_pt_uncUp[43], &b_Jet_pt_jesFlavorPureGluonUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorPureQuarkUp", Jet_pt_jesFlavorPureQuarkUp, &b_Jet_pt_jesFlavorPureQuarkUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorPureQuarkUp", Jet_pt_uncUp[44], &b_Jet_pt_jesFlavorPureQuarkUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorPureCharmUp", Jet_pt_jesFlavorPureCharmUp, &b_Jet_pt_jesFlavorPureCharmUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorPureCharmUp", Jet_pt_uncUp[45], &b_Jet_pt_jesFlavorPureCharmUp);
   //fFriends->SetBranchAddress("Jet_pt_jesFlavorPureBottomUp", Jet_pt_jesFlavorPureBottomUp, &b_Jet_pt_jesFlavorPureBottomUp);
   fFriends->SetBranchAddress("Jet_pt_jesFlavorPureBottomUp", Jet_pt_uncUp[46], &b_Jet_pt_jesFlavorPureBottomUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTimeRunAUp", Jet_pt_jesTimeRunAUp, &b_Jet_pt_jesTimeRunAUp);
   fFriends->SetBranchAddress("Jet_pt_jesTimeRunAUp", Jet_pt_uncUp[47], &b_Jet_pt_jesTimeRunAUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTimeRunBUp", Jet_pt_jesTimeRunBUp, &b_Jet_pt_jesTimeRunBUp);
   fFriends->SetBranchAddress("Jet_pt_jesTimeRunBUp", Jet_pt_uncUp[48], &b_Jet_pt_jesTimeRunBUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTimeRunCUp", Jet_pt_jesTimeRunCUp, &b_Jet_pt_jesTimeRunCUp);
   fFriends->SetBranchAddress("Jet_pt_jesTimeRunCUp", Jet_pt_uncUp[49], &b_Jet_pt_jesTimeRunCUp);
   //fFriends->SetBranchAddress("Jet_pt_jesTimeRunDUp", Jet_pt_jesTimeRunDUp, &b_Jet_pt_jesTimeRunDUp);
   fFriends->SetBranchAddress("Jet_pt_jesTimeRunDUp", Jet_pt_uncUp[50], &b_Jet_pt_jesTimeRunDUp);
   //fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupMPFInSituUp", Jet_pt_jesCorrelationGroupMPFInSituUp, &b_Jet_pt_jesCorrelationGroupMPFInSituUp);
   fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupMPFInSituUp", Jet_pt_uncUp[51], &b_Jet_pt_jesCorrelationGroupMPFInSituUp);
   //fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupIntercalibrationUp", Jet_pt_jesCorrelationGroupIntercalibrationUp, &b_Jet_pt_jesCorrelationGroupIntercalibrationUp);
   ...
   //fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupbJESUp", Jet_pt_jesCorrelationGroupbJESUp, &b_Jet_pt_jesCorrelationGroupbJESUp);
   fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupbJESUp", Jet_pt_uncUp[53], &b_Jet_pt_jesCorrelationGroupbJESUp);
   //fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupFlavorUp", Jet_pt_jesCorrelationGroupFlavorUp, &b_Jet_pt_jesCorrelationGroupFlavorUp);
   fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupFlavorUp", Jet_pt_uncUp[54], &b_Jet_pt_jesCorrelationGroupFlavorUp);
   //fFriends->SetBranchAddress("Jet_pt_jesCorrelationGroupUncorrelatedUp", Jet_pt_jesCorrelationGroupUncorrelatedUp, &b_Jet_pt_jesCorrelationGroupUncorrelatedUp);
...
void DijetAnalysis::Show(Long64_t entry)
{
...
Int_t DijetAnalysis::Cut(Long64_t entry)
{
