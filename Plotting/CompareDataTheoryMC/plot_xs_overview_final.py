...
#	Last modified: B.Schillinger, 24.03.2020			#
#														#
#########################################################
...
def main():
	...
	for i in range(bin_names.size): #should usually be 6
		...
		if(process=="zjet"):
			...
			#data final version:
			plot_xs(bname,ax_xs, data_xax, _ybysbin_factor_zjet[bname]*data, _ybysbin_factor_zjet[bname]*data_err, _ybysbin_col[bname], 7, m_alpha, process, "%s  (%s)"%(_ybysbin_label[bname], _ybysbin_faclab[bname]), True) #data -- marker size originally 6
