...
# Last modified by B. Schillinger, 20.04.2020		   		#
#													   		#
#############################################################
...
def main():
	...
	ax_ratio_NLO.set_ylim(4*1e3, 4*1e6)
	...
	fig_ratio_NLO.savefig("ratio_summary_fnlo_NLO_statuncs.svg")	#as .svg
	fig_ratio_NLO.savefig("ratio_summary_fnlo_NLO_statuncs.pdf")	#as .pdf

	#test with even smaller x-range
	#ax_ratio_NLO.set_xlim(50,1200)
	ax_ratio_NLO.set_xlim(50,800)
	plt.tight_layout()
	fig_ratio_NLO.savefig("ratio_summary_fnlo_NLO_smallxrange_50to800_statuncs.png")
	fig_ratio_NLO.savefig("ratio_summary_fnlo_NLO_smallxrange_50to800_statuncs.svg")	#as .svg
	fig_ratio_NLO.savefig("ratio_summary_fnlo_NLO_smallxrange_50to800_statuncs.pdf")	#as .pdf
