#define JetHT_RunC_chain_cxx
#include "JetHT_RunC_chain.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
// Created via MakeClass out of a TChain containing all the JetHT files for RunC
...
void JetHT_RunC_chain::Loop()
{
//   In a ROOT session, you can do:
//      root> .L JetHT_RunC_chain.C
//      root> JetHT_RunC_chain t
...
void JetHT_RunC_chain::Skim(){

	//create output file
	TFile *skimfile = new TFile("JetHT_RunC_skimmed.root", "recreate");
	...
	const char* dataset_title_1 = "/JetHT/Run2018C-Nano1June2019-v1/NANOAOD";
	...
	metainfo->DrawLatex(0.06, 0.92, Form("Dataset:  #scale[1.2]{#color[30]{/JetHT/Run2018C-Nano1June2019-v1/NANOAOD}}"));
