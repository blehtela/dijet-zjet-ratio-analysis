#define JetHT_RunD_chain_cxx
#include "JetHT_RunD_chain.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
// Created via MakeClass out of a TChain containing all the JetHT files for RunD
...
void JetHT_RunD_chain::Loop()
{
//   In a ROOT session, you can do:
//      root> .L JetHT_RunD_chain.C
//      root> JetHT_RunD_chain t
...
void JetHT_RunD_chain::Skim(){

	//create output file
	TFile *skimfile = new TFile("JetHT_RunD_skimmed.root", "recreate");
	...
	const char* dataset_title_1 = "/JetHT/Run2018D-Nano1June2019_ver2-v1/NANOAOD";
	...
	metainfo->DrawLatex(0.06, 0.92, Form("Dataset:  #scale[1.2]{#color[30]{/JetHT/Run2018D-Nano1June2019_ver2-v1/NANOAOD}}"));
